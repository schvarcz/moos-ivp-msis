...
void FiltroParticulas::roleta( vector <Particula> & populacao)
{
    vector <Particula> populacaoAux;
...
void FiltroParticulas::criarPopulacao(IntervalVector searchSpace, vector <Particula> & populacao, xyz yawPitchRoll)
{
