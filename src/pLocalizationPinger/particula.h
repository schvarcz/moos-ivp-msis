...
//    xyz velXYZ;
    ...
    double calcularPeso(vector<transponder> transpVistos ,vector<Landmark> localizacaoLandmarks);
    double calcularPeso(vector<Landmark> localizacaoLandmarks);
    //int noConjunto(vector <box> caixas);
